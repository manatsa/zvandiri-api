...
public class ChronicInfectionItem extends BaseEntity {
    ...
    @Transient
    private String chronicInfectionId;
    ...
    public String getChronicInfectionId() {
        return chronicInfection!=null?chronicInfection.getId():null;
    }

    public void setChronicInfectionId(String chronicInfectionId) {
        this.chronicInfectionId = chronicInfectionId;
    }
}
