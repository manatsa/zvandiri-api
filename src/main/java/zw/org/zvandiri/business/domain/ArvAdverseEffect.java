...
public class ArvAdverseEffect extends BaseEntity {
    ...
    public String getArvHistId() {
        return arvHist!=null?arvHist.getId():null;
    }

    public void setArvHistId(String arvHistId) {
        this.arvHistId = arvHistId;
    }
}
