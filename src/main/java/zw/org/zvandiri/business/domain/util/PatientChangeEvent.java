...
public enum PatientChangeEvent {
    ...
    /*@JsonCreator
    public static PatientChangeEvent decode(final String code) {
        return Stream.of(PatientChangeEvent.values()).filter(targetEnum -> targetEnum.name().toLowerCase().equals(code.toLowerCase())).findFirst().orElse(null);
    }
*/
