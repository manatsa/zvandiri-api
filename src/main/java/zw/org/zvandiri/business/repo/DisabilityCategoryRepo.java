...
public interface DisabilityCategoryRepo extends CrudRepository<DisabilityCategory, String> {

    @Query(value = "from DisabilityCategory  t ")
    List<DisabilityCategory> findAll(Pageable pageable);
