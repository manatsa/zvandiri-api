...
public interface InternalReferralRepo extends CrudRepository<InternalReferral, String> {

    @Query(value = "from InternalReferral  t")
    List<InternalReferral> findAll(Pageable pageable);
