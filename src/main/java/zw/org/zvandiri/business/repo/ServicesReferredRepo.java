...
public interface ServicesReferredRepo extends CrudRepository<ServicesReferred, String> {

    @Query(value = "from ServicesReferred  t")
    List<ServicesReferred> findAll(Pageable pageable);
