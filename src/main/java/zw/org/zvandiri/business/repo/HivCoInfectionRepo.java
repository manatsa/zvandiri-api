...
public interface HivCoInfectionRepo extends CrudRepository<HivCoInfection, String> {

    @Query(value = "from HivCoInfection  t ")
    List<HivCoInfection> findAll(Pageable pageable);
